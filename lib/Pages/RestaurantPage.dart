...
class ExtractArgumentsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Produtos> item = args.restaurante.produtos;
    for(var i = 0; i < item.length; i++){
      list.add(
        new Row(
          ...
          children: [
              Text(item[i].nome,  style: TextStyle( fontWeight: FontWeight.w500, fontSize: 20)),
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, id) {
                          return ProductContainer(produtos: args.restaurante.produtos[id],);
                        },
                      ),
                    ),
